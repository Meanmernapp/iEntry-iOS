...
extension MessageView {
    ...
    public func configureTheme(_ theme: Theme, iconStyle: IconStyle = .default) {
        ...
        switch theme {
        case .info:
            defaultBackgroundColor = UIColor(red: 66.0/255.0, green: 135.0/255.0, blue: 245.0/255.0, alpha: 1.0)
            defaultForegroundColor = UIColor.white
        case .success:
            defaultBackgroundColor = UIColor(red: 12.0/255.0, green: 69.0/255.0, blue: 35.0/255.0, alpha: 1.0)
            defaultForegroundColor = UIColor.white
        case .warning:
            defaultBackgroundColor = UIColor(red: 254.0/255.0, green: 197.0/255.0, blue: 30.0/255.0, alpha: 1.0)
            defaultForegroundColor = UIColor.white
        case .error:
            defaultBackgroundColor = UIColor(red: 226.0/255.0, green: 87.0/255.0, blue: 76.0/255.0, alpha: 1.0)
            defaultForegroundColor = UIColor.white
        }
