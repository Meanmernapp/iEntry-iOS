...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/AnimatableReload/AnimatableReload.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EPContactsPicker/EPContactsPicker.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SMDatePicker/SMDatePicker.framework"
