//
//  SaveDataInKeyChain.swift
//  iEntry
//
//  Created by ZAFAR on 02/07/2022.
//
...
public class KeychainService: NSObject {
    ...
    public class func saveUDID(token: NSString) {
        self.save(service:UDIDKey as NSString, data: token)
    }

    public class func loadUDID() -> NSString? {
        return self.load(service:UDIDKey as NSString)
    }
