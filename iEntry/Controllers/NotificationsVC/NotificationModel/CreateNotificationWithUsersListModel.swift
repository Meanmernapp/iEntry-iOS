//
//  CreateNotificationWithUsersListModel.swift
//  iEntry
//
...
import Foundation
struct CreateNotificationWithUsersListModel : Codable {
    let code : Int?
    let data : [CreateNotificationWithUsersListModelData]?
    let success : Bool?
    let message : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([CreateNotificationWithUsersListModelData].self, forKey: .data)
...
struct CreateNotificationWithUsersListModelData : Codable {
    let id : String?
    let user : User?
